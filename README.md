...
| `13黄金裔壁纸/<角色>壁纸/` | 每席一个文件夹（`HERO_VISUALS[].assets.homeWallpaperDir`，如 `刻律德菈壁纸/`），任意文件名的 PNG/JPG/WebP，每夹最多取 12 张；`黄金裔全家福与合影/` 供全体会议空间 | 席位主页空间壁纸：进席后按会话稳定选一张，派生为 `<heroId>/home-NN.webp` | 该席回退到杂志封面 16:9 派生物或日历原图。 |
