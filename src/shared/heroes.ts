...
export const HERO_VISUALS: readonly HeroVisual[] = [
  { skill: 'amphoreus-cyrene', heroId: 'cyrene', order: 0, volume: 13, motif: 'ripples',
    ...
    assets: { chronicle: '13昔涟.jpg', calendar: '翁法罗斯2026一年历-封面-昔涟.jpg', card: '13昔涟.png', magazineZip: 'Vol.13_往昔的涟漪_昔涟_14张.zip', sticker: '昔涟-收到.png' } },
  { skill: 'amphoreus-tribbie', heroId: 'tribbie', order: 1, volume: 2, motif: 'stars',
    ...
    assets: { chronicle: '01缇宝.jpg', calendar: '1月-门关月-缇宝.jpg', card: '01缇宝.png', magazineZip: 'Vol.02_命运的三子_缇宝_11张.zip', sticker: '缇宝-睿智.png' },
    faces: ['an', 'ning'] },
  { skill: 'amphoreus-cerydra', heroId: 'cerydra', order: 2, volume: 10, motif: 'checker',
    ...
    assets: { chronicle: '02刻律德菈.jpg', calendar: '2月-平衡月-刻律德菈.jpg', card: '02刻律德菈.png', magazineZip: 'Vol.10_执棋的君主_刻律德菈_12张.zip', sticker: '刻律德菈-将军.png' } },
  { skill: 'amphoreus-march7th', heroId: 'march7th', order: 3, volume: 11, motif: 'film',
    ...
    assets: { chronicle: '03长夜月.jpg', calendar: '3月-长夜月-长夜月.jpg', card: '03长夜月.png', magazineZip: 'Vol.11_隐秘的陌客_长夜月_12张.zip', sticker: '长夜月-去吧.png' },
    faces: ['evernight'] },
  { skill: 'amphoreus-terrae', heroId: 'terrae', order: 4, volume: 12, motif: 'scales',
    ...
    assets: { chronicle: '04丹恒.jpg', calendar: '4月-耕耘月-丹恒.jpg', card: '04丹恒.png', magazineZip: 'Vol.12_腾飞的荒龙_丹恒·腾荒_12张.zip', sticker: '丹恒-倾听.png' } },
  { skill: 'amphoreus-hysilens', heroId: 'hysilens', order: 5, volume: 9, motif: 'waves',
    ...
    assets: { chronicle: '05海瑟音.jpg', calendar: '5月-欢喜月-海瑟音.jpg', card: '05海瑟音.png', magazineZip: 'Vol.09_奏浪的剑骑_海瑟音_12张.zip', sticker: '海瑟音-哼歌.png' } },
  { skill: 'amphoreus-hyacine', heroId: 'hyacine', order: 6, volume: 6, motif: 'clouds',
    ...
    assets: { chronicle: '06风堇.jpg', calendar: '6月-长昼月-风堇.jpg', card: '06风堇.png', magazineZip: 'Vol.06_摇光的医师_雅辛忒丝_12张.zip', sticker: '风堇-治愈.png' } },
  { skill: 'amphoreus-phainon', heroId: 'phainon', order: 7, volume: 8, motif: 'arches',
    ...
    assets: { chronicle: '07白厄.jpg', calendar: '7月-自由月-白厄.jpg', card: '07白厄.png', magazineZip: 'Vol.08_无名的英雄_白厄_12张.zip', sticker: '白厄-诶嘿.png' } },
  { skill: 'amphoreus-anaxa', heroId: 'anaxa', order: 8, volume: 5, motif: 'astrolabe',
    ...
    assets: { chronicle: '08那刻夏.jpg', calendar: '8月-收获月-那刻夏.jpg', card: '08那刻夏.png', magazineZip: 'Vol.05_殁世的学士_阿那克萨戈拉斯_12张.zip', sticker: '那刻夏-看穿.png' } },
  { skill: 'amphoreus-aglaea', heroId: 'aglaea', order: 9, volume: 1, motif: 'gold-thread',
    ...
    assets: { chronicle: '09阿格莱呀.jpg', calendar: '9月-拾线月-阿格莱雅.jpg', card: '09阿格莱雅.png', magazineZip: 'Vol.01_黄金的织者_阿格莱雅_12张.zip', sticker: '阿格莱雅-设计.png' } },
  { skill: 'amphoreus-mydei', heroId: 'mydei', order: 10, volume: 3, motif: 'lion',
    ...
    assets: { chronicle: '10万敌.jpg', calendar: '10月-纷争月-万敌.jpg', card: '10万敌.png', magazineZip: 'Vol.03_亡国的王储_迈德漠斯_11张.zip', sticker: '万敌-狂.png' } },
  { skill: 'amphoreus-castorice', heroId: 'castorice', order: 11, volume: 4, motif: 'butterfly',
    ...
    assets: { chronicle: '11遐蝶.jpg', calendar: '11月-哀悼月-遐蝶.jpg', card: '11遐蝶.png', magazineZip: 'Vol.04_死荫的侍女_遐蝶_14张.zip', sticker: '遐蝶-创作.png' } },
  { skill: 'amphoreus-cipher', heroId: 'cipher', order: 12, volume: 7, motif: 'coins',
    ...
    assets: { chronicle: '12赛飞儿.jpg', calendar: '12月-机缘月-赛飞儿.jpg', card: '12赛飞儿.png', magazineZip: 'Vol.07_捷足的羁客_赛法利娅_12张.zip', sticker: '赛飞儿-得手.png' } },
]
